...
System.register("teamelf/components/Markdown", [], function (_export, _context) {
  "use strict";

  var _extends, _createClass, _class;
...
System.register('teamelf/member/MemberSearcher', [], function (_export, _context) {
  "use strict";

  var _createClass, _antd, Select, Avatar, _class;
      ...
      _class = function (_React$Component) {
        ...
        _createClass(_class, [{
          ...
          value: function fetchMembers() {
            ...
            axios.get('member', { params: { keyword: keyword } }).then(function (r) {
              _this2.setState({ members: r.data });
            });
          }
        }, {
            ...
            return React.createElement(
              ...
              this.state.members.filter(function (o) {
                ...
                return React.createElement(
                  ...
                  React.createElement(Avatar, { style: { float: 'left', marginTop: 5 } }),
                  React.createElement(
                    'div',
                    { style: { marginLeft: 50 } },
                    React.createElement(
                    ...
                    React.createElement(
                      'div',
                      { style: { fontSize: 12, color: '#9d9d9d' } },
                      o.username
                    )
                  )
                );
