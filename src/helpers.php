...
if (! function_exists('app')) {
     ...
     *
     * @param string $make
     * @return mixed|\Doctrine\ORM\EntityManager|\Monolog\Logger|\TeamELF\Application\AbstractApplication|\TeamELF\Config\Config|\TeamELF\Extension\ExtensionManager
     */
